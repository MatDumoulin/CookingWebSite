...
@Component({
  ...
  providers: [
    {provide: MatFormFieldControl, useExisting: RecipenameAutocompleteInput},
    {provide: NG_VALUE_ACCESSOR,useExisting: forwardRef(() => RecipenameAutocompleteInput), multi: true}]
})
